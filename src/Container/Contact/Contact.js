...
function Contact(props) {
  const contactSchema = yup.object({
    name: yup.string().required("Please Enter Your Name").matches(/^[a-zA-Z ]{2,30}$/, "Please enter valid name"),
    email: yup.string().required("Please Enter Email").email("Please enter valid email"),
    subject: yup.string().required("Please Enter subject"),
    message: yup.string().required("Please Enter Message").min(5, "Atleast 5 letters required").max(10, "Max 10 letters allowed"),
  });
